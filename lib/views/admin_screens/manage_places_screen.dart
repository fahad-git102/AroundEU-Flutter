            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                            ...
                            child: InkWell(
                              onTap: (){
                                Navigator.pushNamed(context, PlacesDetailScreen.route, arguments: {
                                  'place' : placesPro.pendingPlacesList?[index].toMap()
                                });
                              },
                              child: PlacesWidget(
                                imageUrl: placesPro.pendingPlacesList?[index].imageUrl,
                                createdBy: placesPro.pendingPlacesList?[index].creatorName,
                                category: placesPro.pendingPlacesList?[index].category,
                                description: placesPro.pendingPlacesList?[index].description,
                                country: placesPro.pendingPlacesList?[index].country,
                              ),
                            ));
                      }
                  )),
                  ...
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: 13.sp),
                    child: Button(text: 'All Places'.tr(), tapAction: (){
